...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s revcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  revcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded revcoin transaction") + "\n" +
              "  revcoin-tx [options] -create [commands]   " + _("Create hex-encoded revcoin transaction") + "\n" +
              "\n";
