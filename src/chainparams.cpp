...
public:
    CMainParams() {
        ...
        //vSeeds.emplace_back("dnsseed.revcointools.com");
        //vSeeds.emplace_back("dnsseed.revcoinpool.org");
        ...
        base58Prefixes[EXT_PUBLIC_KEY] = {0x95, 0x88, 0xB2, 0x1E};
        base58Prefixes[EXT_SECRET_KEY] = {0x95, 0x88, 0xAD, 0xE4};
        ...
        checkpointData = {
            {
                {  0, uint256S("0x61210692f8ce898aa3e1d24d21b6d583537cd5db4569c0b54c8ed015fd446028")},
        ...
        chainTxData = ChainTxData{
            ...
            1536204324, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.revcointools.com");
        vSeeds.emplace_back("seed-b.revcoin.loshan.co.uk");
        ...
        base58Prefixes[EXT_PUBLIC_KEY] = {0x95, 0x35, 0x87, 0xCF};
        base58Prefixes[EXT_SECRET_KEY] = {0x95, 0x35, 0x83, 0x94};
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1536205534 , 82553, 0x1e0ffff0, 1, 25 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("61210692f8ce898aa3e1d24d21b6d583537cd5db4569c0b54c8ed015fd446028"));
        assert(genesis.hashMerkleRoot == uint256S("805d8d176abe872f5cd40b558869a0d25ed02ae471fa33f80185443e5ca9cb40"));
        ...
        checkpointData = {
            {
                {0, uint256S("61210692f8ce898aa3e1d24d21b6d583537cd5db4569c0b54c8ed015fd446028")},
            }
        };
