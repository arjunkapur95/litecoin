...
const char * const BITCOIN_CONF_FILENAME = "revcoin.conf";
const char * const BITCOIN_PID_FILENAME = "revcoind.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Revcoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Revcoin";
#else
    // Unix
    return pathRet / ".revcoin";
#endif
#endif
}
