...
"""Verify that starting revcoin with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start revcoin with -h for help text")
        ...
        self.log.info("Start revcoin with -version for version information")
