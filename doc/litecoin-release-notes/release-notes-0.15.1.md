...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 revs per kB (0.00001 RVC). This is to prepare for dropping the minimum transaction fee to 0.1 revs per kB (0.0001 RVC) in the next release.
