...
* revcoin.conf: contains configuration settings for revcoind or revcoin-qt
* revcoind.pid: stores the process id of revcoind while running
...
* debug.log: contains debug information and general logging generated by revcoind or revcoin-qt
